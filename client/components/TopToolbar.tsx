...
const titleMatchers = [
  ...
  { path: "/channel-manage/:id/listings/new", title: "Create listing" },
  ...
  { path: "/channel-manage/:id", title: "Channel" },
  { path: "/add-channel", title: "Add channel" },
  { path: "/add-channel-step1", title: "Add channel" },
  { path: "/add-channel-step2", title: "Add channel" },
  { path: "/add-channel-step3", title: "Add channel" },
...
const flowCloseMatchers = [
  "/marketplace/channels/:channelId/request",
  "/add-channel",
  "/add-channel-step1",
  "/add-channel-step2",
  "/add-channel-step3",
  "/channel-manage/:id/listings/new",
...
const TopToolbar = () => {
  ...
  const showClose = flowCloseMatchers.some((pattern) =>
