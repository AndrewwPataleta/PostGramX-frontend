...
export const dealsActive: DealCardData[] = [
  {
    id: "FGX-10291",
...
export const dealsPending: DealCardData[] = [
  {
    id: "FGX-10294",
    name: "Market Pulse",
...
export const dealsCompleted: DealCardData[] = [
  {
    id: "FGX-10288",
    name: "Web3 Horizon",
...
export const timelineVerifying: TimelineItem[] = [
  { label: "Accepted", state: "completed" },
...
export const quickFilters = ["Payment Required", "Creative Review", "Scheduled", "Verifying"];
