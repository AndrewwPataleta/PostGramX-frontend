    ...
    <div className="min-h-screen bg-slate-950 px-4 py-10 text-slate-100">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-12">
        ...
        <div className="flex w-full flex-col gap-12">
          {/* Screen 1: Connect channel */}
          <section className="flex w-full flex-col items-center gap-4">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">
              1 · Connect Channel Input Screen
            </p>
          ...
          {/* Screen 2: Channel preview */}
          <section className="flex w-full flex-col items-center gap-4">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">
              2 · Channel Preview Screen
            </p>
            <div className="w-full max-w-sm rounded-[32px] border border-white/10 bg-slate-900/80 shadow-2xl">
              <div className="flex min-h-[720px] flex-col px-5 pb-6 pt-6 safe-area-top safe-area-bottom">
                <div className="space-y-2">
          ...
          {/* Screen 3: Bot permission instructions */}
          <section className="flex w-full flex-col items-center gap-4">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">
              3 · Grant Bot Access Instructions Screen
            </p>
            <div className="w-full max-w-sm rounded-[32px] border border-white/10 bg-slate-900/80 shadow-2xl">
              <div className="flex min-h-[720px] flex-col px-5 pb-6 pt-6 safe-area-top safe-area-bottom">
                <div className="space-y-2">
          ...
          {/* Screen 4: Verifying state */}
          <section className="flex w-full flex-col items-center gap-4">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">
              4 · Verifying State Screen
            </p>
            <div className="w-full max-w-sm rounded-[32px] border border-white/10 bg-slate-900/80 shadow-2xl">
              <div className="flex min-h-[720px] flex-col items-center justify-center gap-4 px-5 pb-6 pt-6 text-center safe-area-top safe-area-bottom">
          ...
          {/* Screen 7: Manager access */}
          <section className="flex w-full flex-col items-center gap-4">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">
              7 · Optional Manager Access Screen
            </p>
            <div className="w-full max-w-sm rounded-[32px] border border-white/10 bg-slate-900/80 shadow-2xl">
              <div className="flex min-h-[720px] flex-col px-5 pb-6 pt-6 safe-area-top safe-area-bottom">
                <div className="space-y-2">
